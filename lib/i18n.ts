...
export const copy = {
  hy: {
    ...
    contact: {
      ...
      name: "Անուն", email: "Էլ. փոստ", project: "Հաղորդագրություն", placeholderName: "Ձեր անունը", placeholderEmail: "you@company.com", placeholderProject: "Մի քանի բառ ձեր գաղափարի մասին", send: "Ուղարկել գաղափարը", helper: "Դեմո ռեժիմում տվյալները չեն ուղարկվում", demoLabel: "ԴԵՄՈ-ՁԵՎ", demoText: "Սա կայքի հնարավորությունների ցուցադրություն է։ Մուտքագրված տվյալները չեն ուղարկվում և չեն պահպանվում։", demoSuccess: "Դեմո-հայտը հաջողությամբ ուղարկված է"
    },
    developer: { eyebrow: "ԿԱՊ ՄՇԱԿՈՂԻ ՀԵՏ", title: "Պատվիրել կայք մշակողից", text: "Եթե ձեզ դուր է եկել այս ցուցադրական կայքը և ցանկանում եք պատվիրել նմանատիպը ձեր բիզնեսի համար, կապվեք ինձ հետ։", telegram: "Telegram", whatsapp: "WhatsApp", instagram: "Instagram", availability: "Բաց համագործակցության համար", action: "Բացել կապը" },
  ...
  ru: {
    ...
    contact: { eyebrow: "ДАВАЙТЕ СОЗДАВАТЬ", title: "Начнём со страницы, мимо которой невозможно пройти спокойно.", text: "Поделитесь идеей — мы вернёмся с первым кадром возможного сайта.", name: "Имя", email: "Эл. почта", project: "Сообщение", placeholderName: "Ваше имя", placeholderEmail: "you@company.com", placeholderProject: "Пара слов о вашей идее", send: "Отправить идею", helper: "В демо-режиме данные не отправляются", demoLabel: "ДЕМО-ФОРМА", demoText: "Это демонстрация возможностей сайта. Введённые данные не отправляются и не сохраняются.", demoSuccess: "Демо-заявка успешно отправлена" },
    developer: { eyebrow: "СВЯЗЬ С РАЗРАБОТЧИКОМ", title: "Заказать сайт у разработчика", text: "Если вам понравился этот демонстрационный сайт и вы хотите заказать похожий для своего бизнеса, свяжитесь со мной.", telegram: "Telegram", whatsapp: "WhatsApp", instagram: "Instagram", availability: "Открыт к сотрудничеству", action: "Открыть связь" },
  ...
  en: {
    ...
    contact: { eyebrow: "LET'S CREATE", title: "Let’s begin with a page people cannot quietly scroll past.", text: "Share an idea — we will return with the first frame of the site it could become.", name: "Name", email: "Email", project: "Message", placeholderName: "Your name", placeholderEmail: "you@company.com", placeholderProject: "A few words about your idea", send: "Send the idea", helper: "Demo mode: data is not submitted", demoLabel: "DEMO FORM", demoText: "This is a demonstration of the site’s capabilities. Your input is not sent or stored.", demoSuccess: "Demo request sent successfully" },
    developer: { eyebrow: "CONNECT WITH THE DEVELOPER", title: "Order a site from the developer", text: "If you enjoyed this demonstration site and want a similar one for your business, get in touch with me.", telegram: "Telegram", whatsapp: "WhatsApp", instagram: "Instagram", availability: "Open for collaboration", action: "Open contact" },
